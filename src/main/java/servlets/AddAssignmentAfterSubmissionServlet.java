...
public class AddAssignmentAfterSubmissionServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //  Forward to add assignment page
        getServletContext().getRequestDispatcher("/addAssignmentAfterSubmission.jsp").forward(request,response);
    }
